...
class SalesforceRequest {
  ...
  public function __construct($requestType, $endpoint, $accessToken, $baseUrl, $apiPrefix) {
    ...
    if (!$this->accessToken) {
      throw new SalesforceException(SalesforceConstants::ERROR_ACCESS_TOKEN);
    }
  ...
  public function execute($client = NULL) {
    ...
    return new SalesforceResponse($result);
  }
   ...
   *
   * @return \Salesforce\Http\SalesforceRequest
   *   SalesforceRequest object.
   */
